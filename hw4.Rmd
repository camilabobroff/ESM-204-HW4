...
XY_agg_intercept <- A1 + B1 + C1 + D1
XY_agg_slope <- A2 + B2 + C2 + D2

# In terms of price
P_XYagg_demand_int <- (-XY_agg_intercept/XY_agg_slope)
P_XYagg_demand_slope <- (1/XY_agg_slope)

XY_agg_abate<- function(q) {P_XYagg_demand_int + P_XYagg_demand_slope*q} 
