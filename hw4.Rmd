...
b_demand_int <- b_curve(180)
b_demand_slope <- (0-b_demand_int)/(180-0)
...
c_demand_int <- c_curve(180)
c_demand_slope <- (0-c_demand_int)/(180-0)
...
d_demand_int <- d_curve(180)
d_demand_slope <- (0-d_demand_int)/(180-0)
